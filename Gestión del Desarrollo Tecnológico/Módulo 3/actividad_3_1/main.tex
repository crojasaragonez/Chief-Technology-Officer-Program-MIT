...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.86\textwidth]{chart.png}
...
La Figura~\ref{fig:merito} señala las innovaciones responsables de la mejora:
transformadores de ultra alta potencia (UHP), metalurgia secundaria, paneles
refrigerados por agua, lanza de oxígeno refrigerada por agua, práctica de
espumación de escoria, horno de cuchara y colada excéntrica por el fondo (EBT),
y manipuladores de lanza. Ninguna constituye una discontinuidad tecnológica y
ninguna sustituyó al horno de arco eléctrico: todas lo refinaron. Es el patrón clásico de una tecnología que ya
...
decrecientes, mientras otras figuras de mérito, como el tiempo de ciclo y el
consumo de electrodos, habían mejorado mucho más y todavía respondían mejor a la
inversión.
