...
genera `foro-6.3-tinymce.html` con las imágenes en base64, listo para
...
def main():
    ...
    html = (AQUI / "foro-6.3.html").read_text(encoding="utf-8")
    ...
    (AQUI / "foro-6.3-tinymce.html").write_text(salida, encoding="utf-8")
    print(f"foro-6.3-tinymce.html: {len(salida.encode('utf-8')) / 1024:.0f} KB, "
