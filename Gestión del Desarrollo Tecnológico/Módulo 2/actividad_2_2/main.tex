...
En este informe, la biomímesis se entiende en un sentido amplio: incluye tanto
la imitación de principios de organización natural como la adaptación
tecnológica directa de mecanismos biológicos. Esta precisión permite comparar
una tecnología que reutiliza componentes moleculares, CRISPR-Cas9, con otra que
convierte un comportamiento biológico en reglas matemáticas, el modelo de
\emph{Physarum}.
...
La Figura~\ref{fig:ilustracion-crispr} presenta de manera conceptual la
transición desde la defensa bacteriana hasta la edición dirigida.

\begin{figure}[ht]
  \centering
  \includegraphics[width=0.96\textwidth]{images/crispr-bioinspiracion.png}
  \caption{Representación conceptual del sistema inmunitario bacteriano y su
  transformación en una herramienta de edición genética. Ilustración generada
  con inteligencia artificial bajo dirección del autor.}
  \label{fig:ilustracion-crispr}
\end{figure}
...
El Cuadro~\ref{tab:traduccion-crispr} compara los componentes naturales con su
función tecnológica, mientras la Figura~\ref{fig:flujo-crispr} resume la
secuencia funcional del diseño.
...
La traducción clínica dejó de ser solamente una posibilidad en diciembre de
2023, cuando la Administración de Alimentos y Medicamentos de Estados Unidos
(FDA) aprobó Casgevy para pacientes de 12 años o más con anemia falciforme y
crisis vasooclusivas recurrentes. Fue la primera terapia aprobada por esa
agencia que utiliza CRISPR-Cas9. El procedimiento modifica fuera del cuerpo las
células madre sanguíneas del propio paciente y las reinfunde para aumentar la
producción de hemoglobina fetal \parencite{fda2023}.
...
Casgevy ofrece una evidencia concreta del impacto clínico, aunque también
ilustra la complejidad de convertir una herramienta de laboratorio en un
tratamiento. En la evaluación utilizada para la aprobación, 29 de 31 pacientes
con seguimiento suficiente permanecieron al menos doce meses sin crisis
vasooclusivas graves. El tratamiento exige extraer células, editarlas,
acondicionar al paciente con quimioterapia y realizar un trasplante; por ello,
el beneficio terapéutico coexiste con costos, riesgos y necesidades de
infraestructura especializada \parencite{fda2023}.
...
La Figura~\ref{fig:ilustracion-physarum} representa la transición desde la red
plasmodial hasta su abstracción como un grafo.

\begin{figure}[ht]
  \centering
  \includegraphics[width=0.90\textwidth]{images/physarum-optimizacion.png}
  \caption{Representación conceptual de la red de tubos de
  \emph{Physarum polycephalum} y su abstracción como un grafo de optimización.
  Ilustración generada con inteligencia artificial bajo dirección del autor.}
  \label{fig:ilustracion-physarum}
\end{figure}
...
El Cuadro~\ref{tab:traduccion-physarum} detalla las equivalencias entre ambos
sistemas y la Figura~\ref{fig:flujo-physarum} sintetiza el ciclo iterativo del
algoritmo.
...
Una aplicación investigada es el diseño sostenible de cadenas de suministro.
Zhang y colaboradores formularon un problema multicriterio en el que la
capacidad y el flujo de cada conexión eran variables, con el propósito de
reducir la inversión, los costos operativos y efectos no deseados como las
emisiones de dióxido de carbono. El modelo inspirado en \emph{Physarum} fue
evaluado mediante ejemplos numéricos \parencite{zhang2017}.
...
El nivel de madurez debe interpretarse con cautela. Los estudios de Tokio y de
cadenas de suministro demuestran capacidad de modelado y optimización, pero no
constituyen evidencia de que redes ferroviarias o empresas operen actualmente
con estos algoritmos. Su impacto comprobado se concentra todavía en
investigación, simulación y apoyo al diseño; la adopción industrial permanece
como una oportunidad que requiere validación en condiciones reales.
