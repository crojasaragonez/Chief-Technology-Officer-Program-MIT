...
\newcommand{\hito}[5]{%
  ...
  \node[#5, text width=2.25cm, align=center, font=\scriptsize, inner sep=1.6pt]
       at ({\tx{#1}},#2) {#4};%
}
...
\newcommand{\barraT}[7]{%
  \node[left, text width=3.35cm, align=right, font=\scriptsize]
       at (-0.12,#1) {#5};%
...
\node[left, font=\scriptsize\itshape, text=cGql, text width=3.4cm, align=right]
     at ({\gx{2019.4}},5.86)
...
\node[anchor=south west, font=\small\bfseries] at (-0.4,4.75)
...
\node[below, font=\scriptsize, text=cGris] at ({\tx{2016}},-0.12) {2016};
\node[below, font=\scriptsize, text=cGris] at ({\tx{2020}},-0.12) {2020};
\node[below, font=\scriptsize, text=cGris] at ({\tx{2024}},-0.12) {2024};

\hito{2012}{1.00}{cGql}{\textbf{2012}\\en producción en el muro de iOS}{above}
\hito{2015}{2.15}{cGql}{\textbf{sep. 2015}\\especificación y graphql-js
  abiertos}{above}
\hito{2016}{1.00}{cRest}{\textbf{sep. 2016}\\GitHub: primera API pública a
  escala}{above right}
\hito{2018.5}{3.30}{cRef}{\textbf{2018 y 2019}\\GraphQL Foundation y Apollo
  Federation v1}{above}
\hito{2024.5}{2.15}{cVerde}{\textbf{2024 y 2025}\\Shopify: REST heredada y
  GraphQL obligatorio}{above}

\umbral{-0.62}{2012.4}{meses: viable \emph{dentro} de Facebook}{cGql}
\umbral{-1.12}{2015.7}{3 años: usable por terceros}{cGql}
\umbral{-1.62}{2016.7}{4 años: probada en público a escala}{cRest}
\umbral{-2.12}{2019.4}{7 años: existe andamiaje de empresa}{cRef}
\umbral{-2.62}{2024.8}{12 años: obligatoria en un dominio}{cVerde}
...
\barraT{2.85}{3400}{1471}{50}{\textbf{REST}\\102 peticiones sobre
  HTTP/1.1}{cRest}{4.921 ms}
\barraT{1.95}{800}{1471}{50}{\textbf{REST}\\102 peticiones\\sobre
  HTTP/2}{cRest}{2.321 ms}
...
\fill[cRest!35] (4.3,-0.72) rectangle (4.72,-0.48);
\node[right, font=\scriptsize] at (4.77,-0.60) {transferencia de los bytes};
\fill[cGris!55] (8.9,-0.72) rectangle (9.32,-0.48);
\node[right, font=\scriptsize] at (9.37,-0.60) {trabajo del servidor (50 ms)};
...
& Coste calculado por consulta: Shopify da 1.000 puntos por ventana y repone
  entre 50 y 500 por segundo. Coste: la capacidad pasa a ser un problema de
  esquema \\
\addlinespace[2pt]
...
\node[anchor=south west, font=\small\bfseries] at (-0.9,4.15)
     {Panel A. La restricción activa de hoy};
\node[anchor=south west, font=\scriptsize\itshape, text=cGris] at (-0.9,3.86)
...
\node[right, font=\scriptsize, text=cVerde, align=left]
     at ({\nx{40}},{\ny{9}}) {con DataLoader: 2 accesos,\\constante en $n$};
...
\node[right, font=\scriptsize, text=cGris, align=left, inner sep=3pt]
     at ({\nx{18}},{\ny{62}}) {mi escenario:\\21 accesos\\frente a 2};
...
\node[below right, font=\scriptsize\itshape, text=cVerde, align=left]
     at ({\fx{57}},{\fy{31}}) {frente de Pareto};
